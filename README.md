...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/cool-waterfall-e9d4#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cool-waterfall-e9d4
```

A live public deployment of this template is available at [https://cool-waterfall-e9d4.templates.workers.dev](https://cool-waterfall-e9d4.templates.workers.dev)
